...
public class Constants {
	...
	public static final String GET_CLASSROOM_FAIL = "{\"message\": \"A Classroom with the specified ID could not be found\"}";
	public static final String GET_TRAINEE_FAIL = "{\"message\": \"A Trainee with the specified ID could not be found\"}";
	public static final String ADD_TRAINEE_SUCCESS = "{\"message\": \"Trainee has been created successfully\"}";
